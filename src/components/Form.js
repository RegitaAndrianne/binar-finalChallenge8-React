...
const Form = (props) => {
    ...
    return (
        <form className="form__control" onSubmit={onSubmit}>
            ...
            <div className="form__control">
                <label>Email</label>
                <input type="email" value={email} onChange={emailOnChangeHandle}></input>
            </div>
            <div className="form__control">
                <label>Experinece</label>
                <select name="experience" value={experience} onChange={experienceOnChangeHandle}>
            ...
            <div className="form__control">
                <label>Level</label>
                <input type="number" value={level} onChange={levelOnChangeHandle}></input>
            </div>

            <button type="submit" className="form__actions">Submit</button>
        </form>
    )
}
